...
export const loginPlatform = '/api/user/loginPlatform'; //创建员工关联的jq用户信息
...
// 通话数据权限分配
export const addDataAllocationRules = '/api/phone/DataAutDis/addDataAllocationRules'; //新增数据分配规则
export const deleteDataAllocationRules = '/api/phone/DataAutDis/deleteDataAllocationRules'; //删除数据分配规则
export const getDataAllocationRulesByUuid = '/api/phone/DataAutDis/getDataAllocationRulesByUuid'; //获取数据分配规则详情
export const getDataAllocationRulesList = '/api/phone/DataAutDis/getDataAllocationRulesList'; //获取数据分配规则集合
export const getDataAllocationStaff = '/api/phone/DataAutDis/getDataAllocationStaff'; //获取数据分配人员信息
export const updateDataAllocationRules = '/api/phone/DataAutDis/updateDataAllocationRules'; //更新数据分配规则
