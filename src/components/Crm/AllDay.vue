<template>
  <el-main class="index-main">
    ...
    <div class="handle-area">
      ...
      <div class="full_msg" v-if="fullLib">
        您的客户数量已达{{ libStandard }}，请释放，否则不能接收新数据。
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      addCludeRule: {
        tel: [{ require: true, message: "请输入手机号", trigger: "blur" }],
        examItem: [
          { require: true, message: "请选择考试项目", trigger: "blur" },
        ],
        school: [{ require: true, message: "请选择分校", trigger: "blur" }],
      },
