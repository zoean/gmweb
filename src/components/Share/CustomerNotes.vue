    ...
    >
      ...
      >
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
            ...
            <el-row>
              <el-col :span="6">
                ...
                <div
                  style="position: relative; left: 226px; top: -42px"
                  v-if="!routePathFlag"
                >
                  <Copy
                ...
                >
                  <area-cascader
                    ...
                    :class="[
                      'screen-li',
                      {
                        areaSelected: ruleForm.city,
                        areaDefault: !ruleForm.city,
                      },
                    ]"
                  ></area-cascader>
                  ...
                  <el-input
                    v-model="ruleForm.provinceCity"
                    :readonly="routePathFlag"
                    :class="routePathFlag ? 'borderNone' : ''"
                    v-if="routePathFlag"
                  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row v-if="followFlag">
              ...
              <el-col :span="6">
                <el-form-item label="截杀承诺" prop="runOutPromise">
                  <el-input
                    v-model="ruleForm.runOutPromise"
                    placeholder="请选择截杀承诺"
                    size="small"
                  ></el-input>
                </el-form-item>
            ...
            <el-row v-if="followFlag">
              ...
              <el-col :span="6">
                <el-form-item label="意向等级" prop="intentionLevel2">
                  <el-select
                    v-model="ruleForm.intentionLevel2"
                    placeholder="请选择意向等级"
                    size="small"
                  >
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item label="截杀承诺" prop="runOutPromise2">
                  <el-input
                    v-model="ruleForm.runOutPromise2"
                    placeholder="请选择截杀承诺"
                    size="small"
                  ></el-input>
                </el-form-item>
        ...
        <el-tab-pane label="订单记录" name="second">
          <el-table :data="orderList" v-loading="pictLoading">
            <el-table-column
      ...
      >
        ...
        <el-row>
          ...
          <el-col :span="15">{{
            notesDetailsForm.notCustomerForm.belongingSeat
          }}</el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="15">{{
            notesDetailsForm.notCustomerForm.createTime
          }}</el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="15">{{
            notesDetailsForm.notCustomerForm.number
          }}</el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="15">{{
            notesDetailsForm.notes.intentionLevel
          }}</el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="15">{{
            notesDetailsForm.notes.nextContactTime
          }}</el-col>
        </el-row>
...
export default {
  ...
  mounted() {
    ...
    if (
      this.$route.path.indexOf("SeatData") != -1 ||
      this.$route.path.indexOf("peopleClues") != -1 ||
      this.$route.path.indexOf("manageClues") != -1 ||
      this.$route.path.indexOf("recoverData") != -1 ||
      this.$route.path.indexOf("toallocate") != -1
    ) {
      this.routePathFlag = true;
    }

    if (
      this.$route.path.indexOf("registered") != -1 ||
      this.$route.path.indexOf("completed") != -1
    ) {
    ...
    getClueDataNotesDetails(id) {
      this.$smoke_post(getClueDataNotesDetails, {
        ...
        if (res.code == 200) {
          ...
          this.notesDetailsForm.form.evidencePurpose =
            res.data.form.evidencePurpose;
          this.notesDetailsForm.form.evidencePurposeOld =
            res.data.form.evidencePurposeOld;
          ...
          this.notesDetailsForm.form.workingLifeOld =
            res.data.form.workingLifeOld;
          this.notesDetailsForm.form.wx = res.data.form.wx;
          this.notesDetailsForm.form.wxOld = res.data.form.wxOld;

          this.notesDetailsForm.notCustomerForm.belongingSeat =
            res.data.notCustomerForm.belongingSeat;
          this.notesDetailsForm.notCustomerForm.createTime = timestampToTime(
            Number(res.data.notCustomerForm.createTime)
          );
          this.notesDetailsForm.notCustomerForm.number =
            res.data.notCustomerForm.number;
          this.notesDetailsForm.notCustomerForm.tel =
            res.data.notCustomerForm.tel;
          ...
          this.notesDetailsForm.notes.comMode = smoke_MJ_4(
            res.data.notes.comMode
          );
          this.notesDetailsForm.notes.entryPerson = res.data.notes.entryPerson;
          this.notesDetailsForm.notes.intentionLevel = smoke_MJ_5(
            res.data.notes.intentionLevel
          );
          this.notesDetailsForm.notes.nextContactTime = timestampToTime(
            Number(res.data.notes.nextContactTime)
          );
          this.notesDetailsForm.notes.remarks = res.data.notes.remarks;
          this.notesDetailsForm.notes.runOutPromise =
            res.data.notes.runOutPromise;
        }
      });
    },
    notesDetails(row) {
    ...
    getClueDataDetails(id) {
      this.$smoke_post(getClueDataDetails, {
        ...
        if (res.code == 200) {
          ...
          this.ruleForm.evidencePurpose =
            res.data.evidencePurpose == 0
              ? ""
          ...
          this.ruleForm.workingLife =
            res.data.workingLife == 0 ? "" : String(res.data.workingLife);
          this.ruleForm.wx = res.data.wx;
          this.ruleForm.school = res.data.school;
          this.ruleForm.callLastTime = timestampToTime(
            Number(res.data.callLastTime)
          );
          this.ruleForm.createTime = timestampToTime(
