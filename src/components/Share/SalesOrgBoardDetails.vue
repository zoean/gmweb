<template>
    <div class="board">
        <el-dialog fullscreen title="通话明细" :visible.sync="boardFlag_" :before-close="handleClose">
...
export default {
    ...
    data() {
        return {
            ...
            columnList: [],
            columnList1: [
                { 'prop': 'orgName', 'label': '统计单位', width: 100 },
                { 'prop': 'callTime', 'label': '总通话时长', width: 110, formatter: this.timeFormatter, 'sortable': true },
                { 'prop': 'callFirstNum', 'label': '首咨总次数', width: 110, 'sortable': true },
                { 'prop': 'firstConTime', 'label': '首咨总时长', width: 110, formatter: this.timeFormatter, 'sortable': true },
                { 'prop': 'callFirstNum1', 'label': '2-3天数据总次数', width: 140, 'sortable': true },
                { 'prop': 'daysTime1', 'label': '2-3天数据总时长', width: 140, formatter: this.timeFormatter, 'sortable': true },
                ...
                { 'prop': 'callNum', 'label': '总通话次数', width: 110, 'sortable': true },
                // { 'prop': 'callStuNum', 'label': '拨打总人数', width: 120, 'sortable': true },
                { 'prop': 'callOpenStuNum', 'label': '接通人数', width: 100, 'sortable': true },
                { 'prop': 'callOpenLv', 'label': '接通率(人数)', width: 120, formatter: this.lvFormatter, 'sortable': true },
            ],
            columnList2: [
                { 'prop': 'saleName', 'label': '统计单位', width: 100 },
                { 'prop': 'callTime', 'label': '总通话时长', width: 110, formatter: this.timeFormatter, 'sortable': true },
                { 'prop': 'callFirstNum', 'label': '首咨总次数', width: 110, 'sortable': true },
                { 'prop': 'firstConTime', 'label': '首咨总时长', width: 110, formatter: this.timeFormatter, 'sortable': true },
                { 'prop': 'callFirstNum1', 'label': '2-3天数据总次数', width: 140, 'sortable': true },
