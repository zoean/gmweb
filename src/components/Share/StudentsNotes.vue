  ...
  <div>
    ...
    >
      ...
      >
          ...
          <el-form :model="customerForm" :rules="rules" ref="customerForm">
            <el-row>
              <el-col :span="6">
                <el-form-item label="客户手机" prop="tel">
                  <el-input
                    v-model.trim="customerForm.tel"
                    readonly
                    size="small"
                    class="borderNone"
                  ></el-input>
                  <div
                    style="position: relative; left: 120px; top: -42px"
                    v-if="!routePathFlag"
                  >
                    <Copy
                      style="display: inline-block; width: auto"
                      @mouseenter.native="phoneCopy('enter')"
                      :content="copyCallbackPhone"
                      @copyCallback="phoneCopy('click')"
                      v-if="!copyPathFlag"
                    >
                      <span
                        ><svg-icon
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="所在省市" prop="provinceCity">
                  <area-cascader
                    type="text"
                    v-model="customerForm.provinceCity"
                    :disabled="routePathFlag"
                    @change="cityChange"
                    :data="pcaa"
                  ></area-cascader>
              ...
              <el-col :span="6">
                <el-form-item label="工作年限" prop="workingLife">
                  <el-select
                    v-model="customerForm.workingLife"
                    placeholder="请选择工作年限"
                    :disabled="routePathFlag"
                    size="small"
                  >
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="取证目的" prop="evidencePurpose">
                  <el-select
                    v-model="customerForm.evidencePurpose"
                    :disabled="routePathFlag"
                    placeholder="请选择取证目的"
                    size="small"
                  >
              ...
              <el-col :span="6">
                <el-form-item label="辅助报名" prop="auxiliarySignUp">
                  <el-select
                    v-model="customerForm.auxiliarySignUp"
                    :disabled="routePathFlag"
                    placeholder="请选择辅助报名"
                    size="small"
                  >
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="报考省份" prop="applyProvince">
                  <el-select
                    v-model="customerForm.applyProvince"
                    placeholder="请选择报考省份"
                    style="width: 100%"
                    size="small"
                    :disabled="routePathFlag"
              ...
              <el-col :span="6">
                <el-form-item label="报考条件" prop="applyExam">
                  <el-select
                    v-model="customerForm.applyExam"
                    placeholder="请选择报考条件"
                    :disabled="routePathFlag"
                    size="small"
                  >
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="毕业院校" prop="graduationSchool">
                  <el-input
                    v-model="customerForm.graduationSchool"
                    :disabled="routePathFlag"
                    placeholder="请输入毕业院校"
                    size="small"
                  ></el-input>
              ...
              <el-col :span="6">
                <el-form-item label="备案金" prop="filingFee">
                  <el-select
                    v-model="customerForm.filingFee"
                    :disabled="routePathFlag"
                    placeholder="请选择缴纳备案金"
                    size="small"
                  >
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item label="学籍状态" prop="studentStatus">
                  <el-select
                    v-model="customerForm.studentStatus"
                    :disabled="routePathFlag"
                    placeholder="请选择学籍状态"
                    size="small"
                  >
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="毕业专业" prop="graduationMajor">
                  <el-input
                    v-model="customerForm.graduationMajor"
                    :disabled="routePathFlag"
                    placeholder="请输入毕业专业"
                    size="small"
                  ></el-input>
              ...
              <el-col :span="6">
                <el-form-item label="注册平台" prop="signUpSchool">
                  <el-input
                    v-model="customerForm.signUpSchool"
                    :disabled="routePathFlag"
                    readonly
                    size="small"
                    class="borderNone"
              ...
              <el-col :span="6">
                <el-form-item label="学习状况" prop="studySituation">
                  <el-select
                    v-model="customerForm.studySituation"
                    :disabled="routePathFlag"
                    placeholder="请选择学习状况"
                    size="small"
                  >
            ...
            <el-row>
              <el-col :span="6" v-if="!routePathFlag">
                <el-form-item label="所属班主任" prop="classTeaName">
                  <el-input
                    v-model="customerForm.classTeaName"
                    readonly
                    size="small"
                    class="borderNone"
                  ></el-input>
              ...
              <el-col :span="6">
                <el-form-item label="报考考期" prop="examPeriodIdList">
                  <el-select
                    v-model="customerForm.examPeriodIdList"
                    multiple
                    :disabled="routePathFlag"
                    placeholder="请选择考期"
                    size="small"
              ...
              <el-col :span="6">
                <el-form-item label="报考员" prop="examaAsistant">
                  <el-input
                    v-model="customerForm.examaAsistant"
                    :disabled="routePathFlag"
                    readonly
                    size="small"
                    class="borderNone"
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="成单坐席" prop="seatName">
                  <el-tooltip
                    effect="dark"
                    v-if="customerForm.orgNameListText != '无'"
                    :open-delay="500"
                    :content="customerForm.orgNameListText"
                    placement="top-start"
                  >
                    <el-input
                      v-model="customerForm.seatName"
                      readonly
                      size="small"
                      class="borderNone"
                    ></el-input>
            ...
            <el-form-item style="text-align: center" v-if="!routePathFlag">
              <el-button
                ...
                >确定</el-button
              >
              <el-button plain size="small" style="width: 80px" @click="quxiao"
                >取消</el-button
              >
            </el-form-item>
          </el-form>
          ...
          <el-table :data="orderList">
            ...
            >
              <template slot-scope="scope">
                <svg-icon
                  icon-title="修改地址"
                  @click="handleEditAddressClick(scope.row)"
                  icon-class="edit"
                  class="svg-handle"
                />
                <svg-icon
                  icon-title="查看协议"
                  @click="lookAgreementDetailsClick(scope.row)"
                  icon-class="info"
                  class="svg-handle"
                />
              </template>
        ...
        <el-tab-pane label="跟进记录" name="second">
          <el-table :data="notesList" style="width: 100%; margin-bottom: 30px">
            <el-table-column
              :prop="item.prop"
              :label="item.label"
        ...
        <el-tab-pane label="课程列表" name="five">
          <div v-if="courseListsFlag">
            <div
              :data="courseLists"
              v-for="(baby, haha) in courseLists"
              :key="haha"
            >
              <div
                style="
              ...
              <div
                v-for="(item, index) in baby.courseList"
                style="
                  padding-left: 50px;
              ...
              >
                ...
                <span style="margin-left: 50px; color: #aaa; font-size: 12px"
    ...
    <el-dialog width="50%" title="设置地址信息" :visible.sync="addressFlag">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addressFlag = false" plain size="small"
          >取 消</el-button
        >
        <el-button
          type="primary"
          @click="addressSubmitForm('ruleFormAddress')"
          size="small"
          >确 定</el-button
        >
      </span>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        idcardNo: [
          {
            pattern: /(^\d{15}$)|bai(^\d{18}$)|(^\d{17}(\d|X|x)$)/,
            required: false,
            message: "请输入正确的身份证号",
            trigger: "blur",
          },
  ...
  created() {
    ...
    if (
      this.$route.path.indexOf("allStudents") != -1 ||
      this.$route.path.indexOf("baokao") != -1
    ) {
  ...
  methods: {
    phoneCopy(text) {
      this.$smoke_post(copyTel, {
        uuid: this.scopeRow.clueDataSUuid,
      }).then((res) => {
        if (res.code == 200) {
          if (text == "click") {
            this.$message({
    ...
    getStudentDetails(id) {
      ...
      this.$smoke_post(getStudentDetails, {
        ...
        if (res.code == 200) {
          ...
          this.customerForm.createTime = timestampToTime(
            Number(res.data.createTime)
          );
          this.customerForm.education =
            res.data.education == 0 || res.data.education == null
              ? ""
              : String(res.data.education);
          this.customerForm.evidencePurpose =
            res.data.evidencePurpose == 0 || res.data.evidencePurpose == null
              ? ""
              : String(res.data.evidencePurpose);
          this.customerForm.examPeriodIdList = res.data.examPeriodIdList;
          this.customerForm.gender =
            res.data.gender == 2 ? "" : res.data.gender;
          ...
          this.customerForm.provinceCity =
            res.data.province == "" && res.data.city == ""
              ? []
              : [res.data.province, res.data.city];
          this.customerForm.signUpSchool = schoolType(res.data.signUpSchool);
          this.customerForm.signUpTime =
            res.data.signUpTime != ""
              ? timestampToTime(Number(res.data.signUpTime))
              : "";
          this.customerForm.studentStatus =
            res.data.studentStatus == 0 || res.data.studentStatus == null
              ? ""
              : String(res.data.studentStatus);
          this.customerForm.studySituation =
            res.data.studySituation == 0 || res.data.studySituation == null
              ? ""
              : String(res.data.studySituation);
          this.customerForm.tel = res.data.tel;
          this.customerForm.twoTel = res.data.twoTel;
          this.customerForm.work = res.data.work;
          this.customerForm.workingLife =
            res.data.workingLife == 0 || res.data.workingLife == null
              ? ""
              : String(res.data.workingLife);
          this.customerForm.wx = res.data.wx;
          if (res.data.seatOrgName && res.data.seatName) {
            this.customerForm.seatName = res.data.seatPOrgName
              ? res.data.seatPOrgName +
                " " +
                res.data.seatOrgName +
                " " +
                res.data.seatName
              : res.data.seatOrgName + " " + res.data.seatName;
          } else {
            this.customerForm.seatName = "";
          }
          this.customerForm.orgNameListText = getTextByJs(
            res.data.orgNameList.reverse()
          ); //reverse()倒序排列
          ...
          this.customerForm.graduationTime = timestampToTime(
            Number(res.data.graduationTime)
          );
          this.customerForm.applyExam =
            res.data.applyExam == 0 || res.data.applyExam == null
              ? ""
              : res.data.applyExam;
