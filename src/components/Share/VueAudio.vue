<template>
  <div class="di main-wrap" v-loading="audio.waiting">
    ...
    ></audio>
    <div>
      <span type="text" @click="startPlayOrPause" style="cursor: pointer;"><i style="font-size: 20px; position: relative; top:2px;" :class="audio.playing | transPlayPause"></i></span>
      
      <el-select v-model="audio.speed" style="display: inline-block; width: 80px; margin-left: 10px; position: relative; top: -1px;" @change="changeSpeedValue" size="mini">
        <el-option
  ...
  export default {
    ...
    data() {
      return {
        ...
        options: [
          {  label: 'x 0.75', value: 0.75},
          {  label: 'x 1', value: 1},
          {  label: 'x 1.5', value: 1.5},
          {  label: 'x 2.0', value: 2.0},
          {  label: 'x 2.5', value: 2.5},
          {  label: 'x 3.0', value: 3.0},
        ]
      }
    },
    methods: {
